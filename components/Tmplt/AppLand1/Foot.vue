					...
					<div class="col-12 col-sm-6 col-lg-3">
						...
						<div class="footer-items">
							...
							<a class="navbar-brand" href="#">
								<img class="logo" src="/preview/app_land_1/assets/img/logo/logo.png" alt="">
							</a>
					...
					<div class="col-12 col-sm-6 col-lg-3">
						...
						<div class="footer-items">
							...
							<div class="button-group store-buttons store-black d-flex flex-wrap">
								<a href="#">
									<img src="/preview/app_land_1/assets/img/icon/google-play-black.png" alt="">
								</a>
								<a href="#">
									<img src="/preview/app_land_1/assets/img/icon/app-store-black.png" alt="">
								</a>
							</div>
						</div>
					</div>
