<template>
    <div class="no-bottom no-top" id="content">
        ...
        <!-- section begin -->
        <section class="text-light" data-bgimage="url(/preview/gigaland/assets/images/background/subheader.jpg)" data-stellar-background-ratio=".2">
...
<script>
    export default {
        ...
        head: {
            title: 'GIGALAND DARK HELP CENTER',
            script:[
