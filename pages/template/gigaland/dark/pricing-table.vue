                ...
                <div class="row sequence">
                    <div class="col-lg-4 col-md-6 col-sm-12 sq-item wow">
                        <div class="pricing-s1 mb30">
                            ...
                            <div class="action">
                                <nuxt-link to="/template/gigaland/dark/register" class="btn-main">Sign Up Now</nuxt-link>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 sq-item wow">
                        <div class="pricing-s1 mb30">
                            <div class="top">
                                <h2>Pro</h2>
                                <p class="plan-tagline">For Individuals</p>
                            </div>
                            <div class="mid text-light bg-color">
                                <p class="price">
                                    <span class="currency">$</span>
...
<script>
    export default {
        ...
        head: {
            title: 'GIGALAND DARK PRICING TABLE',
            script:[
