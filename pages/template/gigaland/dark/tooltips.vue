...
<!-- Mirrored from gigaland.io/tooltips.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Nov 2021 15:16:46 GMT -->
<head>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-8 offset-md-2">
                                ...
                                <button type="button" class="btn btn-main" data-bs-toggle="tooltip" data-bs-placement="top" title="Tooltip on top">
                                  Tooltip on top
                                </button>
                                <button type="button" class="btn btn-main" data-bs-toggle="tooltip" data-bs-placement="right" title="Tooltip on right">
                                  Tooltip on right
                                </button>
                                <button type="button" class="btn btn-main" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Tooltip on bottom">
                                  Tooltip on bottom
                                </button>
                                <button type="button" class="btn btn-main" data-bs-toggle="tooltip" data-bs-placement="left" title="Tooltip on left">
                                  Tooltip on left
                                </button>
                            </div>
                        </div>
