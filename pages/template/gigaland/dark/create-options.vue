            ...
            <div class="container">
                <div class="row wow fadeIn">
                    <div class="col-md-6 offset-md-3">
                        ...
                        <nuxt-link to="/template/gigaland/dark/create-single" class="opt-create">
                            <img src="/preview/gigaland/assets/images/misc/coll-single.png" alt="">
                            <h3>Single</h3>
                        </nuxt-link>
                        <nuxt-link to="/template/gigaland/dark/create-multiple" class="opt-create">
...
<script>
    export default {
        ...
        head: {
            title: 'GIGALAND DARK CREATE OPTIONS',
            script:[
