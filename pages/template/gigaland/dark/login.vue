<template>
    <div class="no-bottom no-top" id="content">
        ...
        <section class="full-height relative no-top no-bottom vertical-center" data-bgimage="url(/preview/gigaland/assets/images/background/subheader.jpg) top" data-stellar-background-ratio=".5">
