...
<!-- Mirrored from gigaland.io/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Nov 2021 15:16:19 GMT -->
<head>
...
<body>
    <div id="wrapper">
        ...
        <div class="no-bottom no-top" id="content">
            <div id="top"></div>
            <section id="section-hero" aria-label="section" class="no-top no-bottom vh-100" data-bgimage="url(images/background/11.jpg) left bottom" data-bgimage_rtl="url(images/background/11-rtl.jpg) left bottom">
                <div class="v-center">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                ...
                                <h1 class="wow fadeInUp" data-wow-delay=".75s">Discover <span class="id-color-2">rare</span> digital art and collect NFTs</h1>
                                ...
                                <a href="create-options.html" class="btn-main btn-light wow fadeInUp lead" data-wow-delay="1.25s">Create</a>
                                <div class="row">
                                <div class="spacer-single"></div>
                                <div class="row">
            ...
            <section id="section-category" class="pt0 pb60">
                <div class="container">
                    <div class="row">
            ...
            <section id="section-popular" class="pt60 pb60" data-bgcolor="#FFF9E1">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
            ...
            <section id="section-collections" class="pt60 pb60" data-bgcolor="#f7ffe7">
                <div class="container">
                    <div class="row">
                        ...
                        <div id="collection-carousel-5-cols" class="owl-carousel wow fadeIn">
                                ...
                                <div class="nft_coll">
                                    ...
                                    <div class="nft_coll_pp">
                                        <a href="collection.html"><img class="lazy pp-coll" src="images/author/author-1.jpg" alt=""></a>
                                        <i class="fa fa-check"></i>
                                    </div>
                                ...
                                <div class="nft_coll">
                                    ...
                                    <div class="nft_coll_pp">
                                        <a href="collection.html"><img class="lazy pp-coll" src="images/author/author-2.jpg" alt=""></a>
                                        <i class="fa fa-check"></i>
                                    </div>
                                    <div class="nft_coll_info">
                                ...
                                <div class="nft_coll">
                                    ...
                                    <div class="nft_coll_pp">
                                        <a href="collection.html"><img class="lazy pp-coll" src="images/author/author-3.jpg" alt=""></a>
                                        <i class="fa fa-check"></i>
                                    </div>
                                    <div class="nft_coll_info">
                                ...
                                <div class="nft_coll">
                                    ...
                                    <div class="nft_coll_pp">
                                        <a href="collection.html"><img class="lazy pp-coll" src="images/author/author-4.jpg" alt=""></a>
                                        <i class="fa fa-check"></i>
                                    </div>
                                    <div class="nft_coll_info">
                                ...
                                <div class="nft_coll">
                                    ...
                                    <div class="nft_coll_pp">
                                        <a href="collection.html"><img class="lazy pp-coll" src="images/author/author-5.jpg" alt=""></a>
                                        <i class="fa fa-check"></i>
                                    </div>
                                    <div class="nft_coll_info">
                                ...
                                <div class="nft_coll">
                                    ...
                                    <div class="nft_coll_pp">
                                        <a href="collection.html"><img class="lazy pp-coll" src="images/author/author-6.jpg" alt=""></a>
                                        <i class="fa fa-check"></i>
                                    </div>
                                    <div class="nft_coll_info">
                ...
                <section id="section-items" class="pt60 pb60" data-bgcolor="#f6f5fb">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
