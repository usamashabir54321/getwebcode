...
<!-- Mirrored from gigaland.io/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Nov 2021 15:16:19 GMT -->
<head>
...
<body>
    <div id="wrapper">
        ...
        <div class="no-bottom no-top" id="content">
            <div id="top"></div>
            <section id="section-hero" class="no-bottom" data-bgimage="url(images/background/12.jpg) bottom">
                <div class="container">
                    <div id="items-carousel-big" class="owl-carousel">
                        ...
                        <div class="nft__item_lg">
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    <img src="images/carousel/crs-7.jpg" class="img-fluid" alt="">
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-desc">
                                        ...
                                        <div class="d-buttons">
                                            <a href="wallet.html" class="btn-main">Place a bid</a>&nbsp;
                                            <a href="item-details.html" class="btn-main btn-light">View artwork</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="nft__item_lg">
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    <img src="images/carousel/crs-8.jpg" class="img-fluid" alt="">
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-desc">
                        ...
                        <div class="nft__item_lg">
                            <div class="row align-items-center">
                                <div class="col-lg-6">
                                    <img src="images/carousel/crs-9.jpg" class="img-fluid" alt="">
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-desc">
                                        <h2>Cute Island</h2>
...
<!-- Mirrored from gigaland.io/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Nov 2021 15:16:21 GMT -->
</html>