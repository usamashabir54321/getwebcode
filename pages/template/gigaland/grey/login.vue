    ...
    <body class="dark-scheme de-grey">
        <div id="wrapper">
            ...
            <div class="no-bottom no-top" id="content">
                ...
                <section class="full-height relative no-top no-bottom vertical-center" data-bgimage="url(/preview/gigaland/assets/images/background/6.jpg) top" data-stellar-background-ratio=".5">
