                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-3 mb30">
                                <a class="box-url" href="/template/gigaland/grey/login">
                            ...
                            <div class="col-lg-3 mb30">
                                <a class="box-url" href="/template/gigaland/grey/login">
                                    <img src="/preview/gigaland/assets/images/wallet/7.png" alt="" class="mb20">
                                    <h4>Authereum</h4>
                            ...
                            <div class="col-lg-3 mb30">
                                <a class="box-url" href="/template/gigaland/grey/login">
                                    ...
                                    <img src="/preview/gigaland/assets/images/wallet/8.png" alt="" class="mb20">
                                    <h4>Torus</h4>
                                    <p>Open source protocol for connecting decentralised applications to mobile wallets.</p>
                                </a>
                            </div>                                  
