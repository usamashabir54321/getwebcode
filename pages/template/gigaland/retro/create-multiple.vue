...
<!-- Mirrored from gigaland.io/create-multiple.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 16 Nov 2021 15:17:13 GMT -->
<head>
                            ...
                            <div class="de-flex-col header-col-mid">
                                ...
                                <div class="menu_side_area">
                                    <div class="de-login-menu">
                                        <a href="create-options.html" class="btn-main btn-wallet"><i class="icon_wallet_alt"></i><span>Create</span></a>
                ...
                <div class="container">
                    <div class="row wow fadeIn">
                        <div class="col-lg-7 offset-lg-1">
                            <form id="form-create-item" class="form-border" method="post" action="https://gigaland.io/email.php">
                                <div class="field-set">
                                    <h5>Upload file</h5>
                                    ...
                                    <input type="text" name="item_royalties" id="item_royalties" class="form-control" placeholder="E.g. 25" />
                        ...
                        <div class="col-lg-3 col-sm-6 col-xs-12">
                                ...
                                <div class="nft__item">
                                    ...
                                    <div class="nft__item_wrap">
                                        <a href="#">
                                            <img src="images/collections/coll-item-2.jpg" id="get_file_2" class="lazy nft__item_preview" alt="">
                                        </a>
                                    </div>
