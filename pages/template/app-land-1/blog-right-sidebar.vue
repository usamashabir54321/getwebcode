					...
					<div class="col-12">
						...
						<div class="breadcrumb-content text-center">
							...
							<ol class="breadcrumb d-flex justify-content-center">
								<li class="breadcrumb-item"><nuxt-link to="/template/app-land-1/index-2">Home</nuxt-link></li>
						...
						<div class="row">
							<div class="col-12 col-md-6">
								...
								<div class="single-blog res-margin">
									...
									<div class="blog-thumb">
										<a href="#"><img src="/preview/app_land_1/assets/img/blog/blog-1.jpg" alt=""></a>
									</div>
									<!-- Blog Content -->
							...
							<div class="col-12 col-md-6">
								...
								<div class="single-blog res-margin">
									<!-- Blog Thumb -->
									<div class="blog-thumb">
										<a href="#"><img src="/preview/app_land_1/assets/img/blog/blog-2.jpg" alt=""></a>
									</div>
									<!-- Blog Content -->
									<div class="blog-content p-4">
										<!-- Meta Info -->
							...
							<div class="col-12 col-md-6">
								...
								<div class="single-blog">
									<!-- Blog Thumb -->
									<div class="blog-thumb">
										<a href="#"><img src="/preview/app_land_1/assets/img/blog/blog-3.jpg" alt=""></a>
									</div>
									<!-- Blog Content -->
									<div class="blog-content p-4">
										<!-- Meta Info -->
							...
							<div class="col-12 col-md-6">
								...
								<div class="single-blog res-margin">
									<!-- Blog Thumb -->
									<div class="blog-thumb">
										<a href="#"><img src="/preview/app_land_1/assets/img/blog/blog-4.jpg" alt=""></a>
									</div>
									<!-- Blog Content -->
									<div class="blog-content p-4">
										<!-- Meta Info -->
							...
							<div class="col-12 col-md-6">
								...
								<div class="single-blog res-margin">
									<!-- Blog Thumb -->
									<div class="blog-thumb">
										<a href="#"><img src="/preview/app_land_1/assets/img/blog/blog-5.jpg" alt=""></a>
									</div>
									<!-- Blog Content -->
									<div class="blog-content p-4">
										<!-- Meta Info -->
							...
							<div class="col-12 col-md-6">
								...
								<div class="single-blog">
									<!-- Blog Thumb -->
									<div class="blog-thumb">
										<a href="#"><img src="/preview/app_land_1/assets/img/blog/blog-6.jpg" alt=""></a>
									</div>
									<!-- Blog Content -->
									<div class="blog-content p-4">
										<!-- Meta Info -->
											...
											<ul class="widget-items">
												<li>
													<a href="#" class="single-post media p-3">
														...
														<div class="post-thumb avatar-md">
															<img class="align-self-center" src="/preview/app_land_1/assets/img/avatar/avatar-1.png" alt="">
														</div>
												...
												<li>
													<a href="#" class="single-post media p-3">
														<!-- Post Thumb -->
														<div class="post-thumb avatar-md">
															<img class="align-self-center" src="/preview/app_land_1/assets/img/avatar/avatar-2.png" alt="">
														</div>
														<div class="post-content media-body pl-3">
												...
												<li>
													<a href="#" class="single-post media p-3">
														<!-- Post Thumb -->
														<div class="post-thumb avatar-md">
															<img class="align-self-center" src="/preview/app_land_1/assets/img/avatar/avatar-3.png" alt="">
														</div>
														<div class="post-content media-body pl-3">
												...
												<li>
													<a href="#" class="single-post media p-3">
														<!-- Post Thumb -->
														<div class="post-thumb avatar-md">
															<img class="align-self-center" src="/preview/app_land_1/assets/img/avatar/avatar-4.png" alt="">
														</div>
														<div class="post-content media-body pl-3">
...
<script>
	export default {
		...
		head: {
            title: 'LANDING 1 BLOG RIGHT SIDE',
        },
	}
</script>