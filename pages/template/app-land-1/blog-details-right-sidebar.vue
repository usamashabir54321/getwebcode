					...
					<div class="col-12 col-lg-9">
						...
						<article class="single-blog-details">
							...
							<div class="blog-thumb">
								<a href="#"><img src="/preview/app_land_1/assets/img/blog/blog-7.jpg" alt=""></a>
							</div>
							<!-- Blog Content -->
							...
							<div class="blog-comments">
								...
								<div class="admin media py-3">
									...
									<div class="admin-thumb avatar-lg">
										<img class="rounded-circle" src="/preview/app_land_1/assets/img/avatar/avatar-1.png" alt="">
									</div>
									<!-- Admin Content -->
								...
								<div class="comments my-3">
									...
									<div class="single-comments media p-3 p-lg-4">
										...
										<div class="comments-thumb avatar-lg">
											<img class="rounded-circle" src="/preview/app_land_1/assets/img/avatar/avatar-2.png" alt="">
										</div>
										<!-- Comments Content -->
									...
									<div class="single-comments media p-3 p-lg-4">
										<!-- Comments Thumb -->
										<div class="comments-thumb avatar-lg">
											<img class="rounded-circle" src="/preview/app_land_1/assets/img/avatar/avatar-3.png" alt="">
										</div>
										<!-- Comments Content -->
										<div class="comments-content media-body pl-3">
											<h5 class="d-flex mb-2">
...
<script>
	export default {
		...
		head: {
            title: 'LANDING 1 BLOG DETAILS RIGHT SIDE',
        },
	}
</script>