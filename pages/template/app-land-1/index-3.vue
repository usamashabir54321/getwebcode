			...
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-12 col-md-5 col-lg-6">
						<!-- Welcome Thumb -->
						<div class="welcome-thumb text-left text-md-center mx-auto">
							<!-- Play Button -->
				...
				<div class="row align-items-center">
						...
						<ul class="features-item">
							<li>
								...
								<div class="image-box media px-1 py-3 py-md-4 wow fadeInLeft" data-aos-duration="2s" data-wow-delay="0.3s">
									...
									<div class="featured-img mr-3">
										<img class="avatar-sm" src="/preview/app_land_1/assets/img/icon/featured-img/layers.png" alt="">
									</div>
									<!-- Icon Text -->
							...
							<li>
								...
								<div class="image-box media px-1 py-3 py-md-4 wow fadeInLeft" data-aos-duration="2s" data-wow-delay="0.6s">
									<!-- Featured Image -->
									<div class="featured-img mr-3">
										<img class="avatar-sm" src="/preview/app_land_1/assets/img/icon/featured-img/speak.png" alt="">
									</div>
									<!-- Icon Text -->
									<div class="icon-text media-body align-self-center align-self-md-start">
							...
							<li>
								...
								<div class="image-box media px-1 py-3 py-md-4 wow fadeInLeft" data-aos-duration="2s" data-wow-delay="0.9s">
									<!-- Featured Image -->
									<div class="featured-img mr-3">
										<img class="avatar-sm" src="/preview/app_land_1/assets/img/icon/featured-img/lock.png" alt="">
									</div>
									<!-- Icon Text -->
									<div class="icon-text media-body align-self-center align-self-md-start">
					...
					<div class="col-12 col-lg-4 d-none d-lg-block">
						...
						<div class="features-thumb text-center">
							<img src="/preview/app_land_1/assets/img/features/thumb-1.png" alt="">
						</div>
					</div>
					<div class="col-12 col-md-6 col-lg-4">
						<!-- Features Item -->
						<ul class="features-item">
							<li>
								...
								<div class="image-box media px-1 py-3 py-md-4 wow fadeInRight" data-aos-duration="2s" data-wow-delay="0.3s">
									<!-- Featured Image -->
									<div class="featured-img mr-3">
										<img class="avatar-sm" src="/preview/app_land_1/assets/img/icon/featured-img/support.png" alt="">
									</div>
									<!-- Icon Text -->
									<div class="icon-text media-body align-self-center align-self-md-start">
							...
							<li>
								...
								<div class="image-box media px-1 py-3 py-md-4 wow fadeInRight" data-aos-duration="2s" data-wow-delay="0.6s">
									<!-- Featured Image -->
									<div class="featured-img mr-3">
										<img class="avatar-sm" src="/preview/app_land_1/assets/img/icon/featured-img/seo-and-web.png" alt="">
									</div>
									<!-- Icon Text -->
									<div class="icon-text media-body align-self-center align-self-md-start">
							...
							<li>
								...
								<div class="image-box media px-1 py-3 py-md-4 wow fadeInRight" data-aos-duration="2s" data-wow-delay="0.9s">
									<!-- Featured Image -->
									<div class="featured-img mr-3">
										<img class="avatar-sm" src="/preview/app_land_1/assets/img/icon/featured-img/code.png" alt="">
									</div>
									<!-- Icon Text -->
									<div class="icon-text media-body align-self-center align-self-md-start">
				...
				<div class="row">
					<div class="col-12 col-md-4">
						...
						<div class="single-work text-center p-3">
							<!-- Work Icon -->
							<div class="work-icon">
								<img class="avatar-md" src="/preview/app_land_1/assets/img/icon/work/download.png" alt="">
							</div>
					...
					<div class="col-12 col-md-4">
						...
						<div class="single-work text-center p-3">
							<!-- Work Icon -->
							<div class="work-icon">
								<img class="avatar-md" src="/preview/app_land_1/assets/img/icon/work/settings.png" alt="">
							</div>
					...
					<div class="col-12 col-md-4">
						...
						<div class="single-work text-center p-3">
							<!-- Work Icon -->
							<div class="work-icon">
								<img class="avatar-md" src="/preview/app_land_1/assets/img/icon/work/app.png" alt="">
							</div>
				...
				<div class="row justify-content-between">
					...
					<div class="col-12 col-lg-6 order-1 order-lg-2 d-none d-md-block">
						...
						<div class="service-thumb mx-auto">
							<img src="/preview/app_land_1/assets/img/welcome/welcome-mockup-2.png" alt="">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row justify-content-between align-items-center">
					<div class="col-12 col-lg-6 order-2 order-lg-1">
						...
						<div class="service-thumb discover-thumb mx-auto pt-5 pt-lg-0">
							<img src="/preview/app_land_1/assets/img/discover/iphone_x.png" alt="">
						</div>
					</div>
					<div class="col-12 col-lg-6 order-1 order-lg-2">
						<!-- Discover Text -->
						<div class="discover-text pt-4 pt-lg-0 px-0 px-lg-4">
							<h2 class="pb-4">More productivity with less effort</h2>
							<!-- Service List -->
							<ul class="service-list style-two">
								<!-- Single Service -->
								<li class="single-service py-2">
					...
					<div class="col-12 col-md-6 col-lg-4 res-margin">
						...
						<div class="single-review card">
							...
							<div class="card-top p-4">
								...
								<!-- Quotation Icon -->
								<div class="quot-icon">
									<img class="avatar-md" src="/preview/app_land_1/assets/img/icon/quote.png" alt="">
								</div>
							</div>
							<!-- Reviewer -->
							<div class="reviewer media bg-gray p-4">
								...
								<div class="reviewer-thumb">
									<img class="avatar-lg radius-100" src="/preview/app_land_1/assets/img/avatar/avatar-1.png" alt="">
								</div>
								<!-- Reviewer Media -->
					...
					<div class="col-12 col-md-6 col-lg-4 res-margin">
						...
						<div class="single-review card">
							...
							<div class="reviewer media bg-gray p-4">
								<!-- Reviewer Thumb -->
								<div class="reviewer-thumb">
									<img class="avatar-lg radius-100" src="/preview/app_land_1/assets/img/avatar/avatar-2.png" alt="">
								</div>
								<!-- Reviewer Media -->
								<div class="reviewer-meta media-body align-self-center ml-4">
									<h5 class="reviewer-name color-primary mb-2">Junaid Hasan</h5>
					...
					<div class="col-12 col-md-6 col-lg-4">
						...
						<div class="single-review card">
							...
							<div class="reviewer media bg-gray p-4">
								<!-- Reviewer Thumb -->
								<div class="reviewer-thumb">
									<img class="avatar-lg radius-100" src="/preview/app_land_1/assets/img/avatar/avatar-3.png" alt="">
								</div>
								<!-- Reviewer Media -->
								<div class="reviewer-meta media-body align-self-center ml-4">
									<h5 class="reviewer-name color-primary mb-2">Junaid Hasan</h5>
						...
						<div class="row price-plan-wrapper">
							<div class="col-12 col-md-6">
								...
								<div class="single-price-plan text-center p-5 wow fadeInLeft" data-aos-duration="2s" data-wow-delay="0.4s">
									...
									<div class="plan-thumb">
										<img class="avatar-lg" src="/preview/app_land_1/assets/img/pricing/basic.png" alt="">
									</div>
									<!-- Plan Title -->
							...
							<div class="col-12 col-md-6 mt-4 mt-md-0">
								...
								<div class="single-price-plan text-center p-5 wow fadeInRight" data-aos-duration="2s" data-wow-delay="0.4s">
									<!-- Plan Thumb -->
									<div class="plan-thumb">
										<img class="avatar-lg" src="/preview/app_land_1/assets/img/pricing/premium.png" alt="">
									</div>
									<!-- Plan Title -->
									<div class="plan-title my-2 my-sm-3">
					...
					<div class="col-12 col-md-10 col-lg-9">
						...
						<div class="download-text text-center">
							...
							<div class="button-group store-buttons d-flex justify-content-center">
								<a href="#">
									<img src="/preview/app_land_1/assets/img/icon/google-play.png" alt="">
								</a>
								<a href="#">
									<img src="/preview/app_land_1/assets/img/icon/app-store.png" alt="">
								</a>
							</div>
...
<script>
	export default {
		layout: 'landing_pgs/app_land_1/1_lty',
		head: {
			title: 'LANDING 1 HOME 3',
			script: [
				{ src:'/preview/app_land_1/assets/js/plugins/plugins.min.js' , defer: 'defer' },
				{ src:'/preview/app_land_1/assets/js/active.js' , defer: 'defer' },
			],
		},
	}
</script>
