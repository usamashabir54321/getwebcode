				...
				<div class="row align-items-center">
					...
					<div class="col-12 col-md-5 col-lg-6">
						...
						<div class="welcome-thumb mx-auto" data-aos="fade-left" data-aos-delay="500" data-aos-duration="1000">
							<img src="/preview/app_land_1/assets/img/welcome/welcome-mockup.png" alt="">
						</div>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-12 col-sm-6 col-md-4 col-lg-3">
						...
						<div class="single-team text-center overflow-hidden m-2 m-lg-0">
							...
							<div class="team-thumb d-inline-block position-relative overflow-hidden">
								<img src="/preview/app_land_1/assets/img/avatar/avatar-1.png" alt="">
								<!-- Team Overlay -->
					...
					<div class="col-12 col-sm-6 col-md-4 col-lg-3">
						...
						<div class="single-team text-center overflow-hidden m-2 m-lg-0">
							<!-- Team Thumb -->
							<div class="team-thumb d-inline-block position-relative overflow-hidden">
								<img src="/preview/app_land_1/assets/img/avatar/avatar-2.png" alt="">
								<!-- Team Overlay -->
								<div class="team-overlay">
					...
					<div class="col-12 col-sm-6 col-md-4 col-lg-3">
						...
						<div class="single-team text-center overflow-hidden m-2 m-lg-0">
							<!-- Team Thumb -->
							<div class="team-thumb d-inline-block position-relative overflow-hidden">
								<img src="/preview/app_land_1/assets/img/avatar/avatar-3.png" alt="">
								<!-- Team Overlay -->
								<div class="team-overlay">
					...
					<div class="col-12 col-sm-6 col-md-4 col-lg-3">
						...
						<div class="single-team text-center overflow-hidden m-2 m-lg-0">
							<!-- Team Thumb -->
							<div class="team-thumb d-inline-block position-relative overflow-hidden">
								<img src="/preview/app_land_1/assets/img/avatar/avatar-4.png" alt="">
								<!-- Team Overlay -->
								<div class="team-overlay">
